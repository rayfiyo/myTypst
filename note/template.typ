...
// Delete the abstruct as it is not needed.
...
#let master_thesis(
  // Delete the co ver as it is not needed.
  ...
  // Delete the document's metadata (ex. author) as it is not needed.
  ...
  // The first page.
  // Delete the cover as it is not needed.
